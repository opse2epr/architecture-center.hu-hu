...
## <a name="drone-delivery-analyzing-the-business-domain"></a>Drone Delivery: Elemzését az üzleti tartomány.
...
## <a name="drone-delivery-applying-the-patterns"></a>A drone delivery: a minták alkalmazásának
