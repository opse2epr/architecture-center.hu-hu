            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Küldje be az ötleteit az Architecture Centernek</h3>
                            <p>Vannak arra vonatkozó ötletei, hogy milyen új, az architektúrával vagy a tervezéssel kapcsolatos dokumentációra lenne még szükség?</p>
                            <p>Milyen témájú cikkeket látna szívesen az Azure Architecture Centerben?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3> A kiváló Azure-architektúra alappillérei</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3> Biztonsági tervezés az Azure-ban</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Tervezés az Azure-ban a teljesítmény és a méretezhetőség figyelembevételével</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Hatékonyságra és műveletekre tervezés az Azure-ban</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Rendelkezésre állásra és helyreállíthatóságra tervezés az Azure-ban</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ismerkedés az N szintű architektúrastílussal</h3>
                    </div>
                </div>
            </div>
        </div>
