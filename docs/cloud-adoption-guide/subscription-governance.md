...
* Most, hogy az előfizetés-irányítás megismerkedett, ideje, hogy ezek a javaslatok a gyakorlatban. Lásd: [példák az Azure előfizetés-irányítás végrehajtási](subscription-governance-examples.md).
