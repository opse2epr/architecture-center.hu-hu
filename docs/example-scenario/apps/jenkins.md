...
- **Jenkins-kiszolgáló**. A virtuális gép telepítve van a Futtatás [Jenkins] [ azure-market] , egy automation-kiszolgáló és a Jenkins-főkiszolgálóként szolgál. Ez a virtuális gép üzembe helyezéséhez használja a [készült Jenkins megoldássablon][solution]. Az egyéb Jenkins-ajánlatok az Azure Marketplace áruházban érhetők el.
