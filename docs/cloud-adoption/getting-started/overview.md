...
## <a name="digital-transformation-process"></a>A digitális átalakulás: folyamatban
...
## <a name="step-1-create-a-cloud-strategy-team"></a>1. lépés: Felhő stratégia csapat létrehozása
...
## <a name="step-4-align-high-level-solutions-with-business-groups-to-design-solutions"></a>4. lépés: a magas szintű megoldások az üzleti csoportok tervezési megoldások igazítása 
