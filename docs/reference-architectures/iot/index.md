...
- A javasolt architektúrát és a megvalósítási lehetőségeket a [Microsoft Azure IoT referenciaarchitektúráját](https://aka.ms/iotrefarchitecture) tartalmazó dokumentum (PDF) ismerteti részletesebben.
