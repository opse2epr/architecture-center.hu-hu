...
Ez az architektúra látható egy épít [futtassa egy Windows virtuális gép Azure][single vm]. A javaslatok nem ez az architektúra is vonatkozik.
