...
Ez a cikk bemutatja a bevált eljárást egy Windows virtuális gép (VM) az Azure-ban. Javaslatokat tartalmaz a VM, valamint a hálózatkezelési és tárolási összetevők üzembe helyezéséhez. [**A megoldás üzembe helyezése.**](#deploy-the-solution)
