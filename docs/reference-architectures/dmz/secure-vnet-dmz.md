...
Ez a referenciaarchitektúra a [DMZ az Azure és a helyszíni adatközpont közötti implementálásával kapcsolatos][implementing-a-secure-hybrid-network-architecture] cikkben ismertetett architektúrát bővíti ki. Hozzáadja a nyilvános DMZ-t, amely kezeli az internetes forgalmat a helyszíni hálózat érkező forgalmat kezelő privát DMZ mellett.
...
3. Keresse meg a `/dmz/ssecure-vnet-hybrid` referencia architektúrák GitHub-adattár mappát.
