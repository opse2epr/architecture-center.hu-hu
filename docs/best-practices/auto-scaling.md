...
A beépített metrikák listájáért lásd: [Az Azure Monitor automatikus skálázáshoz használt közös metrikái][autoscale-metrics]. Application Insights segítségével Megvalósíthat egyéni metrikákat is.
