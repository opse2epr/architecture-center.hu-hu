...
Az alábbi ábrán látható egy példatárfiókban logikai struktúráját. A tárfiók három táblát tartalmaz: Customer Info (ügyféladatok), Product Info (termékadatok) és Order Info (megrendelésadatok). 
...
* Ha rendszeresen hajt végre lekérdezéseket, amelyek a partíció- és sorkulcsot kulcsok eltérő mezők alapján adatokat kereshet, vegye fontolóra a [Indextábla minta], vagy fontolja meg egy másik adattárhoz, amely támogatja az indexelést, például a Cosmos DB használatával .
