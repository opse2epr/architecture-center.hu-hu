        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Hírcsatornák tömeges betöltése és elemzése az Azure-ban</h3>
                        <p>Folyamat létrehozása szövegek, képek, hangulatok és egyéb, RSS-hírcsatornákból származó adatok betöltéséhez és elemzéséhez, kizárólag Azure-szolgáltatások (például Azure Cosmos DB és Azure Cognitive Services) használatával.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>CI-/CD-folyamat tárolóalapú számítási feladatokhoz</h3>
                        <p>DevOps-folyamatot hozhat létre egy Node.Js-webalkalmazáshoz a Jenkins, az Azure Container Registry, az Azure Kubernetes Service, a Cosmos DB és a Grafana használatával.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Intelligens termékkereső motor az e-kereskedelem számára</h3>
                        <p>Világszínvonalú keresési élményt nyújthat egy e-kereskedelmi alkalmazásban.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Jenkins-kiszolgáló futtatása az Azure-on</h3>
                        <p>Ajánlott architektúra, amely egy egyszeri bejelentkezéssel (SSO) biztosított, skálázható, nagyvállalati szintű Jenkins-kiszolgáló üzembe helyezését és üzemeltetését mutatja be az Azure-on.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>IoT és adatelemzés az építőiparban</h3>
                        <p>IoT-eszközök és adatelemzés használatával biztosíthatja az építési projektek átfogó felügyeletét és működését.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Adattárházak és elemzések értékesítési és marketingterületen</h3>
                        <p>Egyesítheti több forrásból származó adatait, és optimalizálhatja az adatelemzést.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Gépjárművek valós idejű IoT-adatainak betöltése és feldolgozása</h3>
                        <p>Valós idejű járműadatokat tölthet be és dolgozhat fel az IoT használatával.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Linux rendszerű virtuális asztali környezetek a Citrix-szel</h3>
